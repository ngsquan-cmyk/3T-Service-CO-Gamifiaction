...
const TUTORIAL_KEY = "mm_3t_tutorial_seen";
...
export default function Home() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-b from-primary/5 to-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="bg-white p-6 rounded-3xl shadow-xl border border-border mb-8">
          ...
          <div className="space-y-4">
            <Button
              size="lg"
              className="w-full h-14 text-lg font-bold rounded-xl shadow-md hover:scale-[1.02] transition-transform bg-secondary hover:bg-secondary/90 text-white"
      ...
      {/* Tutorial overlay — shown only on first play */}
      <AnimatePresence>
